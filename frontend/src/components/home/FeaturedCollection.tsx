...
// MOCK DATA
const ALL_PRODUCTS = [
  { id: 1, name: "Kumkumadi Tailam", price: "$45.00", category: "Oils", image: "https://images.unsplash.com/photo-1608248597279-f99d160bfbc8?auto=format&fit=crop&w=800&q=80" },
  { id: 2, name: "Saffron Elixir", price: "$62.00", category: "Serums", image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=800&q=80" },
  { id: 3, name: "Rose Water Mist", price: "$28.00", category: "Skin", image: "https://images.unsplash.com/photo-1601049541289-9b1b7bbbfe19?auto=format&fit=crop&w=800&q=80" },
  { id: 4, name: "Bhringraj Oil", price: "$35.00", category: "Hair", image: "https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?auto=format&fit=crop&w=800&q=80" },
];

const CATEGORIES = ["All", "Oils", "Skin", "Hair", "Serums"];
        ...
        <div className="relative -mt-32 mb-16 z-20">
          <div className="bg-white/90 dark:bg-neutral-900/90 backdrop-blur-lg shadow-2xl rounded-2xl p-6 border border-neutral-200 dark:border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="relative w-full md:w-1/3 group">
              <Search className="absolute left-0 top-2 h-5 w-5 text-neutral-400 group-focus-within:text-black dark:group-focus-within:text-white transition-colors" />
              <input 
                type="text" 
                placeholder="Search products..." 
                className="w-full pl-8 pr-4 py-2 bg-transparent border-b border-neutral-300 dark:border-neutral-700 text-black dark:text-white focus:outline-none focus:border-black dark:focus:border-white transition-colors placeholder-neutral-400"
              />
            </div>

            {/* LOGIC: Render Categories */}
                ...
                >
                  <div className="aspect-[4/5] overflow-hidden rounded-xl bg-neutral-200 dark:bg-neutral-800 mb-4 relative">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                      <LuxuryButton className="w-full py-3 text-xs shadow-xl">
                        Add to Cart
                      </LuxuryButton>
                    </div>
                  </div>

                  <h3 className="font-serif text-xl text-neutral-900 dark:text-white">{product.name}</h3>
